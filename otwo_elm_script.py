...
from model.main.hybrid_elm import OTwoElm, LTwoElm
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_otwo_elm"
else:
    pass
...
def train_model(item):
    ...
    md = LTwoElm(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, two_paras=two_paras)
    md._running__()
