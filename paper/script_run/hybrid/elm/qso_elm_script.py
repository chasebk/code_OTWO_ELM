...
from model.main.hybrid_elm import QsoElm
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import qso_elm_paras_final as param_grid
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_qso_elm"
else:
    pass
...
def train_model(item):
    ...
    md = QsoElm(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, qso_paras=qso_paras)
    md._running__()
