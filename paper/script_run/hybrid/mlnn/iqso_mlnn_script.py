...
from model.main.hybrid_mlnn import IQsoMlnn
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_iqso_mlnn"
else:
    pass
...
def train_model(item):
    ...
    md = IQsoMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, qso_paras=qso_paras)
    md._running__()
