...
from model.main.hybrid_mlnn import BeeMlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import bee_mlnn_paras_final as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_bee_mlnn"
else:
    pass
...
def train_model(item):
    ...
    md = BeeMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, abc_paras=abc_paras)
    md._running__()
