...
from model.main.hybrid_mlnn import WoaMlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import whale_mlnn_paras_final as param_grid
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_woa_mlnn"
else:
    pass
...
def train_model(item):
    ...
    md = WoaMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, woa_paras=woa_paras)
    md._running__()
