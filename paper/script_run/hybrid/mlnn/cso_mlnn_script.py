...
from model.main.hybrid_mlnn import CsoMlnn
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_cso_mlnn"
else:
    pass
...
def train_model(item):
    ...
    md = CsoMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, cso_paras=cso_paras)
    md._running__()
