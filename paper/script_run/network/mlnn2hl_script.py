...
from model.main.traditional_ffnn import Mlnn2HL
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import mlnn2hl_paras_final as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_mlnn2hl"
else:
    pass
...
def train_model(item):
    ...
    md = Mlnn2HL(root_base_paras=root_base_paras, root_mlnn_paras=root_mlnn_paras)
    md._running__()
