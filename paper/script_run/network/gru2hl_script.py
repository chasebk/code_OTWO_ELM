...
from model.main.traditional_rnn import Gru2HL
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import gru2hl_paras_final as param_grid
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_gru2hl"
else:
    pass
...
def train_model(item):
    ...
    md = Gru2HL(root_base_paras=root_base_paras, root_rnn_paras=root_rnn_paras)
    md._running__()
